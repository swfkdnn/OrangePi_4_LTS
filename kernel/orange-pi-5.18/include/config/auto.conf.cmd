deps_config := \
	...
	drivers/staging/fusb30x/Kconfig \
...
ifneq "$(KERNELVERSION)" "5.18.5"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "ccache aarch64-none-linux-gnu-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "ccache aarch64-none-linux-gnu-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "aarch64-none-linux-gnu-gcc (GNU Toolchain for the A-profile Architecture 9.2-2019.12 (arm-9.10)) 9.2.1 20191025"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "ccache aarch64-none-linux-gnu-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "ccache aarch64-none-linux-gnu-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(PAHOLE)" "pahole"
include/config/auto.conf: FORCE
...
ifneq "$(AR)" "ccache aarch64-none-linux-gnu-ar"
include/config/auto.conf: FORCE
endif
